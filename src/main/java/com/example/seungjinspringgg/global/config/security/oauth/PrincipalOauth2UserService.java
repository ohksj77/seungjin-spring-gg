package com.example.seungjinspringgg.global.config.security.oauth;

import com.example.seungjinspringgg.global.config.security.auth.PrincipalDetails;
import com.example.seungjinspringgg.global.config.security.oauth.provider.FaceBookUserInfo;
